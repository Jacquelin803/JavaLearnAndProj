...
import systemCourses.DB.mybatis.dto.GoodsDTO;
import systemCourses.DB.mybatis.entity.Goods;
import systemCourses.DB.mybatis.entity.GoodsDetail;
import systemCourses.DB.mybatis.utils.MyBatisUtils;
...
public class MyBatisTest {
    ...
    public void testSelectBYPriceRange() throws Exception {
        ...
        try{
            ...
            para.put("max",500);
            para.put("limt",7);
            List<Goods> goodsList = sqlSession.selectList("goods.selectByPriceRange", para);
            for(Goods g:goodsList){
    ...
    public void testUpdate() throws Exception {
        ...
        try{
            sqlSession=MyBatisUtils.openSession();
            Goods goods = sqlSession.selectOne("goods.selectById", 2675);
            goods.setTitle("update02");
    ...
    public void testDelete(){
        ...
        try{
            sqlSession=MyBatisUtils.openSession();
            int num = sqlSession.delete("goods.delete", 2675);
            sqlSession.commit();
        }catch (Exception e){
            if(sqlSession!=null){
                sqlSession.rollback();
